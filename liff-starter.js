...
function textFooter(){
    var tipe = getParameterByName('footer');
        ...
        if (tipe === 'text') {
            liff.sendMessages([{
                ...
                sentBy: {
                    ...
                    linkUrl: "line://app/1602687308-DgedGk9A?footer=text&text="+getParameterByName('text')}
            }]).then(function () {
                liff.closeWindow();
            });
        }
        ...
        if (tipe === 'image') {
            liff.sendMessages([{
                ...
                sentBy: {
                    label: prof.displayName,
                    iconUrl: prof.pictureUrl,
                    linkUrl: "line://app/1602687308-DgedGk9A?footer=image&img="+getParameterByName('img')}
            }]).then(function () {
                liff.closeWindow();
            });
        }
